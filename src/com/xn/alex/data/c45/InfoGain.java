...
public class InfoGain {
    ...
    public InfoGain(Vector<Vector<String>> data,Vector<String> attribute){
    ...
    public Map<String,Long> getAttributeValueTargetValue(String attributeName,int attributeIndex){
        ...
        Iterator<Vector<String>> iterator = data.iterator();
        
        while(iterator.hasNext()){
        	
        	Vector<String> tempList = iterator.next();
    ...
    public Vector<Vector<String>> getData4Value(String attrValue,int attrIndex){
        ...
        for(;iterator.hasNext();){
            ...
            if(templist.get(attrIndex).equalsIgnoreCase(attrValue)){
            	...
            	//Vector<String> clone = (Vector<String>) templist.clone();
            	
				//Vector<String> temp = clone;
    ...
    //获得TARGET值
    public static Vector<String> getTarget(Vector<Vector<String>> data){
    ...
    //判断当前纯度是否100%
    public static String IsPure(Vector<String> list){
