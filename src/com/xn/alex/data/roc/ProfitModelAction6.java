...
public class ProfitModelAction6 extends ProfitModelInterface implements ActionListener{
	...
	public ProfitModelAction6(){
	 ...
	 public void takeAction(){
		...
		public void createWindow(){
		    ...
		    JLabel title = new JLabel("投诉客户预警利润分析",JLabel.CENTER);
		    ...
		    JLabel a = new JLabel("N:客户总数"+"--α:投诉客户占比--"+"V:投诉处理成本"+"--"+"γ:关怀成功率");
		    
		    a.setFont(new java.awt.Font("Dialog", Font.ITALIC, 13));

		    topPanel.add(a);
		    
		    JLabel b = new JLabel("c:关怀激励成本--"+"d:关怀接触成本"+"--"+"F0:模型命中率"
		    +"--"+"F1:模型误判率--F2:模型成功率");
