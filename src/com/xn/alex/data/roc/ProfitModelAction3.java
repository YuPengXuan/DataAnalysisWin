...
public class ProfitModelAction3 extends ProfitModelInterface implements ActionListener{
	...
	public ProfitModelAction3(){
	 ...
	 public void takeAction(){
		...
		public void createWindow(){
		    ...
		    JLabel title = new JLabel("4G短信营销利润分析",JLabel.CENTER);
		    ...
		    ImageIcon imageicon1 =new ImageIcon(ClassLoader.getSystemResource("images/4G短信营销.png"));
		    ...
		    JLabel b = new JLabel("d：短信接触成本--b：短信打扰代价--F0：模型命中率--F1：模型误判率--F2：模型成功率");
